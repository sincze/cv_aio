...
#define SKETCH_VERSION     "0.5"                        // Can Reset the OTGW (using 1 relais)
...
//--------------------------------------------------------------------------------------------
// Door / Switches (Leakage and Door)
//--------------------------------------------------------------------------------------------
...
byte switchPin[NUMBER_OF_SWITCHES] = {5,6};             // what digital pin we're connected to Digital Pin 5 Door
